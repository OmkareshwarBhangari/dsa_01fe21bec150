...
// Function to print the tree in inorder traversal and write to a file
...
// Function to print the tree in preorder traversal and write to a file
...
// Function to print the tree in postorder traversal and write to a file
...
int main() {
    ...
    do {
        ...
        printf("3. Print the tree (inorder traversal)\n");
        printf("4. Print the tree (preorder traversal)\n");
        printf("5. Print the tree (postorder traversal)\n");
        printf("6. Exit\n");
    ...
    FILE* fp = fopen("avl_tree.txt", "w");
    if (fp == NULL) {
        printf("Error opening the file.\n");
        return 1;
    }

    printf("Writing the tree to a file...\n");

    fprintf(fp, "AVL tree (inorder traversal): ");
    inorderTraversal(root, fp);
    fprintf(fp, "\n");

    fprintf(fp, "AVL tree (preorder traversal): ");
    preorderTraversal(root, fp);
    fprintf(fp, "\n");

    fprintf(fp, "AVL tree (postorder traversal): ");
    postorderTraversal(root, fp);
    fprintf(fp, "\n");

    fclose(fp);
    printf("Tree written to the file avl_tree.txt successfully!\n");
